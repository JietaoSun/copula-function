...
Monitor = readmatrix('Monitoring point residual data_2.xlsx'); % Note: Read the residual data as a numerical matrix
X1=Monitor(:,1); % Extract the residual data from th.xlsx'); % Read data from the file 'Monitoring Point Residual Data.xlsx'
